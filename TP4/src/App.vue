<template>
  ...
  <main>
    <section class="filtres">
      ...
      <b>Par prix :</b>
      <label>
        <input type="radio" v-model="prixFiltre" value="croissant" /> Croissant
      </label>
      <label>
        <input type="radio" v-model="prixFiltre" value="decroissant" /> Décroissant
      </label>
      <br /><br />
      <b>Par nom :</b>
      <input type="text" v-model="searchTitle" placeholder="Rechercher..." />
      <br /><br />
      <b>Disponibilité :</b>
      <label>
        <input type="checkbox" v-model="dispoFiltre" value="dispo" /> Disponibles
      </label>
      <label>
        <input type="checkbox" v-model="dispoFiltre" value="indispo" /> Indisponibles
      </label>
      <br /><br />
      <b>Par catégorie :</b>
